...
\setlength{\headsep}{2mm} % \headsep 命令定义了页眉底部线与正文顶部线之间的距离。 这将页眉和正文之间的距离设置为1英寸
\setlength{\footskip}{2mm} % \footskip 的值来增加页脚上方的空白。 这将页脚和正文之间的距离设置为1英寸

\fancyhead[L]{Ph.D. candidate Zhijian Lai}  % 设置页眉左侧的内容为 "PhD Zhijian Lai"
...
\fancypagestyle{plain}{  % 定义一个新的页面样式 'plain'
	...
	\fancyhead[L]{Ph.D. candidate Zhijian Lai} 
...
%	 Equalizing the number of cafeteria users.
%	 Mitigating congestion caused by the decision of stops on the Tobu Isezaki Line.
%	 In University-Community Collaboration 2020:
%	 
%	 Selecting evacuation shelters during disasters.
%	 In University-Community Collaboration 2021:
%	 
%	 Developing a self-study schedule program to maximize efficiency.
%	 
\end{SectionTable}
